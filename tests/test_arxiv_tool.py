...
运行:
    /home/prime/Codes/Docs/.venv/bin/python -m pytest /home/prime/Codes/Docs/tests/ -v
    /home/prime/Codes/Docs/.venv/bin/python -m pytest /home/prime/Codes/Docs/tests/ -v -m "not network"  # 跳过网络测试
"""
...
class TestCmdCited:
    ...
    def test_offset_passed_through(self):
        ...
        with patch("arxiv_tool._fetch_citations_s2", return_value=(fake_results, 100)) as mock_s2:
            ...
            assert call_args[0][2] == 20 or kwargs.get("offset") == 20  # 第3个位置参数或 kwarg
